...
<div class="d-flex justify-content-center align-items-center text-white text fw-bold"
   ...
   <h1 class="display-1" style="color:#fff">Energía Renovable</h1>
</div>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="section-header d-flex flex-wrap justify-content-between mb-5" >
               <h2 class="section-title" style="color:#003588">Energía Renovable</h2>
               <div class="row">
                  <div class="col-md-12">
                  <p>
                        
                        En DIME Ofrecemos proyecto de energía renovable costo vs beneficio, venta de paneles y material necesario para la instalación, ejecución de la instalación.
                        </p> <p>
                        Brindamos a cada uno de nuestros clientes que nos visitan y que nos siguen a través de nuestras redes sociales una asesoría profesional y especializada. </p>
