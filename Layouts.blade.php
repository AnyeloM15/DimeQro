...
<html lang="es">
  <head>
    ...
    <title>Dimeqro - Iluminación y Material Eléctrico</title>
    ...
    <link rel="shortcut icon" href="images/logoDime.png" style="height: 20px; width: 80px;" />
  ...
  <body>
    ...
    <a href="https://wa.me/4421071706" target="_blank" class="btn-whatsapp-float">
      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-3 text-center text-sm-start">
            <div class="main-logo">
              <a href="index.html">
                <img src="images/logoDime.png" style="height: 100px; width: auto;" alt="logo" class="img-fluid">
              </a>
            </div>
          </div>
            ...
            <div class="search-bar row bg-light p-2 my-2 rounded-4">
              <div class="col-md-4 d-none d-md-block">
                <select class="form-select border-0 bg-transparent">
                  ...
                  <option>Iluminación</option>
                    <option>Iluminación Exterior</option>
                    <option>Iluminación Interior</option>
                    <option>Iluminación Vial</option>
                    <option>Placas y Accesorios Eléctricos</option>
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="index.html" method="post">
                  <input type="text" class="form-control border-0 bg-transparent" placeholder="Busque entre más de 20,000 productos" />
                </form>
              </div>
              <div class="col-1">
          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            <div class="support-box text-end d-none d-xl-block">
              <span class="fs-6 text-muted">Llamanos!!</span>
              <h5 class="mb-0">(442)107-1706</h5>
            </div>

            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="#" class=" bg-light p-2 mx-1" style="text-decoration:none;color:#003588">
                  <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#user"></use></svg> <strong>Mi cuenta</strong>
                </a>
              </li>
              <li>
                <a href="#" class="rounded-circle bg-light p-2 mx-1">
                  <svg style="color:#e3032b" width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#heart"></use></svg>
                </a>
              </li>
              <li class="d-lg-none">
          ...
          <div class="d-flex  justify-content-center justify-content-sm-between align-items-center">
            <nav class="main-menu d-flex navbar navbar-expand-lg">
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <!-- Categorias de lamparas *(traerlas de la base de datos para renderizar) -->
                  <select class="filter-categories border-0 mb-0 me-5">
                    <option>Busca por categoría</option>
                    <option>Iluminación</option>
                    <option>Iluminación Exterior</option>
                    <option>Iluminación Interior</option>
                    <option>Iluminación Vial</option>
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                     <li class="nav-item active">
                      <a href="#women" class="nav-link">Inicio</a>
                    </li>
					...
					<li class="nav-item active">
					 ...
					 <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="pages">
                        <li><a href="Solu_Iluminacion.html" class="dropdown-item">Iluminación  </a></li>
                        <li><a href="Solu_Material.html" class="dropdown-item">Material Eléctrico </a></li>
                        <li><a href="Solu_EngRenovable.html" class="dropdown-item">Energía Renovable </a></li>
                        <li><a href="Cart.html" class="dropdown-item">Cart </a></li>
                        <li><a href="Checkout.html" class="dropdown-item">Checkout </a></li>
                        <li><a href="Solu_InstalacionElec.html" class="dropdown-item">Instalación Eléctrica </a></li>
                        <li><a href="Solu_Levantamiento.html" class="dropdown-item">Levantamiento y Conteo en obra y/o Planos en Obra </a></li>
                        <li><a href="Solu_Garantia.html" class="dropdown-item">Garantía y Postventa </a></li>
                      </ul>
                    </li>
					
					<li class="nav-item active">
                      <a href="#women" class="nav-link">SIMON</a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="#men" class="nav-link">TECNOLITE</a>
                    </li>
                    <li class="nav-item">
                      <a href="#kids" class="nav-link">IUSA</a>
                    </li>
                    <li class="nav-item">
                      <a href="#accessories" class="nav-link">TLapps</a>
                    </li>
                    
                    <li class="nav-item">
                      <a href="#brand" class="nav-link">CALUX</a>
                    </li>
                    <li class="nav-item">
                      <a href="#blog" class="nav-link">PHILCO</a>
                    </li>
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">Calux</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">TLapps</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Simon</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Iusa</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Philco</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Tecnolite</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">Lámparas</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Interiores</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Exteriores</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Accesorios eléctricos</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Conductores</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Iluminación vial</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Materiales eléctricos</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="tel:+524421071706" class="nav-link">Tel: 4421071706</a>
                </li>
                <li class="menu-item">
                  <a href="mailto:ventas@dimeqro.com" class="nav-link">ventas@dimeqro.com</a>
                </li>
                <li class="menu-item">
                  <span class="nav-link">Blvrd de los Gobernadores 1981</span>
                </li>
                <li class="menu-item">
                  <span class="nav-link">Villas del Cimatario, San Andrés</span>
                </li>
                <li class="menu-item">
                  <span class="nav-link">76085 Querétaro, Qro.</span>
                </li>
              </ul>
            </div>
          </div>
